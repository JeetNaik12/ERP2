...
include("../DB/db.php");
    ...
    $qry1 = "Select i.id,i.rate,i.item_name,i.qnt,i.unit_id,u.unit_name from tbl_item as i inner join tbl_unit as u on i.unit_id = u.id where i.id = $item_id";
    ...
    { 
        ...
        $new_array[$row['id']]['rate'] = $row['rate'];
    }
